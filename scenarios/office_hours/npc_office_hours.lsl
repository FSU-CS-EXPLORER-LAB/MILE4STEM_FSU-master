//
// LSL script created from an NPCDL file at Tue Jun 26 17:42:00 EDT 2018
//
...
list npc_5_OM_path = ["<0.0,0.0,0.0>" , "<8.0,0.0,0.0>", "<0.0,-4.0,0.0>"];
...
OfficeMovment()
{
    ...
    {
        to_destination(npc_3_OM_path, 5);
    }
    else if(myid == 4)
    {
        to_destination(npc_4_OM_path, 5);
    }
    else if(myid == 5)
    {
        to_destination(npc_5_OM_path, 5);
    }
    else if(myid == 6)
    {
        to_destination(npc_6_OM_path, 5);
    }
    return;
}
...
set_offset()
{
    ...
    npc_state_control_channel = npc_state_control_base_channel + myid + scenario_offset;
    npc_para_control_channel = npc_para_control_base_channel + myid + scenario_offset;
    npc_action_control_channel = npc_action_control_base_channel + myid + scenario_offset;
    scenario_to_npc = scenario_recieve_base_channel + myid + scenario_offset;
